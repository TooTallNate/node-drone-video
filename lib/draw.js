...
function draw (data, width, height) {
  ...
  // write rotation
  ctx.fillText('left-right (x): ' + data.demo.rotation.x + '°', 10, 135);
  ctx.fillText('font-back (y): ' + data.demo.rotation.y + '°', 10, 160);
  ctx.fillText('clockwise (z): ' + data.demo.rotation.z + '°', 10, 185);
